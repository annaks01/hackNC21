localStorage.setItem("davisInitBeenCalled", false);

function initRateDavis() {
    if(!localStorage.getItem("davisInitBeenCalled")) {
        // gender neutral
        ...
        // changing init var
        localStorage.setItem("davisInitBeenCalled", true);
    }  
...
function submit() {
    ...
    // returning to page 2
    window.location.href="../page2davis.html?genderNeutral=" + localStorage.getItem("genderNeutralPercent") + 
